...
public class navNode {
    ...
    public void addNeighbour(navNode arg1, int arg2) {
        neighbours.addElement(new navNode(arg1.getId(), arg1.getCor(), arg2));
        edges.addElement(new navEdge(Cor.x, Cor.y, arg1.getCor().x, arg1.getCor().y, arg1.getId(), arg2));
    }
    ...
    public void draw(Graphics g) {
        ...
        for (int i=0; i < neighbours.size(); i++) { 
            navNode tmpNode = (navNode)neighbours.elementAt(i);
